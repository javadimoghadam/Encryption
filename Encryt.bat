...
title Encrypt (ali_javadi)
color a
:mainmenu
set savefile=on
::set Encrypt=Nothing
(set CHAR[a]=M8A5K1) & (set CHAR[b]=H21DGF) & (set CHAR[c]=FDH56D) & (set CHAR[d]=FGS546) & (set CHAR[e]=JUK4JH)
...
echo please enter secret massage:
set /p Encrypt=
cls
...
echo massage secret shode: %Encrypt%
echo.
